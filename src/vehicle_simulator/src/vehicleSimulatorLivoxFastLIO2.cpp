...
int main(int argc, char** argv)
{
  ...
  // NOTE: this is just for debug, as FASTLIO2 uses livox custom data, and for vehicleSimulator, it requires pt2 type.
  // In final simulation, I should use e.g. Husky Simulator + livox with customMsg + LOAM stuff, then use LOAM interface from the cmu stack to fully simulate the system.
  ros::Subscriber subScan = nh.subscribe<sensor_msgs::PointCloud2>("/livox/lidar_pt2", 2, scanHandler);
